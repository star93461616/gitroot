/* ! Chart.js v2.9.3 https://www.chartjs.org (c) 2019 Chart.js Contributors
...
!function (t, e) {
    ...
    var S = {
            ...
            easeInOutBounce: function (t) {
                return t < .5
                    ? .5 * S.easeInBounce(2 * t)
                    : .5 * S.easeOutBounce(2 * t - 1) + .5
            }
        },
        C = {
            effects: S
            ...
            _parseFont: function (t) {
                var e = z.global,
                    ...
                    i = {
                        ...
                        lineHeight: M
                            .options
                            .toLineHeight(N(t.lineHeight, e.defaultLineHeight), n),
                        size: n,
    ...
    V.extend(et.prototype, {
        ...
        buildOrUpdateElements: function () {
            var t,
                ...
                i = n.getDataset(),
                a = i.data || (i.data = []);
            n._data !== a && (n._data && tt(n._data, n), a && Object.isExtensible(a) && (
                e = n,
                (t = a)._chartjs
    ...
    var ft = X.extend({
            ...
            draw: function (t) {
                var e = this._view,
                    ...
                    l = z.global,
                    u = l.defaultColor;
                e.skip || (void 0 === t || V.canvas._isPointInArea(e, t)) && (
    ...
    var Ut = nt.extend({
            ...
            if (a.options.elements.line.capBezierPoints) 
                    for (t = 0, e = l.length; t < e; ++t) 
                        ...
                        ), t < l.length - 1 && Vt(l[t + 1]._model, s) && (
    ...
    var Le = {
        ...
        Oe = {
            ...
            updateScaleDefaults: function (t, e) {
                this
                    .defaults
                    .hasOwnProperty(t) && (this.defaults[t] = V.extend(this.defaults[t], e))
            },
    ...
    V.extend(Qe.prototype, {
        ...
        update: function (t) {
            ...
            if (t && "object" == typeof t || (t = {
                ...
                i.updateLayout(),
                i.options.animation && i.options.animation.duration && V.each(
                    a,
                    (function (t) {
                        t.reset()
                    })
        ...
        handleEvent: function (t) {
            ...
            V.callback(i.onHover || i.hover.onHover, [
                t.native, n.active
            ], n),
    ...
    function gn(t, e) {
        return V.extend(V.options._parseFont({
            ...
            color: V
                .options
                .resolve([e.fontColor, t.fontColor, z.global.defaultFontColor])
        })
    }
    function pn(t) {
        var e = gn(t, t.minor);
    ...
    var Dn = Sn.extend({
            ...
            for (t = 0; t < d; ++t) 
                ...
                a.min = V.isFinite(a.min) && !isNaN(a.min)
                    ? a.min
                    : 0,
                a.max = V.isFinite(a.max) && !isNaN(a.max)
                    ? a.max
                    : 1,
    ...
    var Rn = xn.extend({
            determineDataLimits: function () {
                ...
                o.min = V.isFinite(o.min)
                    ? o.min
                    : null,
                o.max = V.isFinite(o.max)
                    ? o.max
                    : null,
    ...
    var ki = {
            ...
            afterDatasetsUpdate: function (t, e) {
                ...
                for (i = 0; i < o; ++i) 
                    r = null,
                    (a = (n = t.getDatasetMeta(i)).dataset) && a._model && a instanceof _t.Line && (
                        r = {
                ...
                ? (
                    t = (
                        V.isArray(n.text)
                            ? n.text.length
                            : 1
                    ) * V.options._parseFont(n).lineHeight + 2 * n.padding,
                    e.width = i.width = a
                        ? e.maxWidth
                        : t,
                    e.height = i.height = a
    ...
    for (
        ...
        function () {
            ...
            V.getMaximumWidth = function (t) {
                ...
                var n = e.clientWidth,
                    i = n - V._calculatePadding(e, "padding-left", n) - V._calculatePadding(
                        e,
                        "padding-right",
                        n
                    ),
            ...
            V.getMaximumHeight = function (t) {
                ...
                var n = e.clientHeight,
                    i = n - V._calculatePadding(e, "padding-top", n) - V._calculatePadding(
                        e,
                        "padding-bottom",
                        n
                    ),
